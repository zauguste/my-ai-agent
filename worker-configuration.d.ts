/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 7b3fdf9bc0f5cc90f6e8204a4b1ef459)
// Runtime types generated with workerd@1.20260828.1 2025-01-01 nodejs_compat
interface __BaseEnv_Env {
	MYBROWSER: BrowserRun;
	AI: Ai;
	MY_AGENT: DurableObjectNamespace<import("./src/index").MyCustomAgent>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "MyCustomAgent";
	}
